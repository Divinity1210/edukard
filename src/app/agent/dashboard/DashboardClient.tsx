...
export default function DashboardClient({ profile, agentProfile, stats, referrals }: { profile: any, agentProfile: any, stats: any, referrals: any[] }) {
  const [copied, setCopied] = useState(false);
  
  // Use the referral code from the agent profile if available, otherwise fallback
        ...
        <table style={s.table}>
          ...
          <tbody>
            ...
            {topReferrals.length === 0 && (
              <tr>
                <td colSpan={5} style={{...s.td, textAlign: "center"}}>No referrals yet. Share your link to get started!</td>
              </tr>
            )}
          </tbody>
        </table>
